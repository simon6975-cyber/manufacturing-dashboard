...
const MACHINES: Record<number, { name: string; model: string; maker: string; group: string }> = {
  ...
  3:  { name: '롤재단 1호기',       model: 'S2020',        maker: 'TECHNAU',    group: '내지' },
  4:  { name: '롤재단 2호기',       model: 'S2320',        maker: 'TECHNAU',    group: '내지' },
  ...
  10: { name: '낱장재단 1호기',   model: 'POLAR 92',     maker: 'HEIDELBERG', group: '표지' },
  11: { name: '낱장재단 2호기',   model: 'C860',         maker: '대호',        group: '표지' },
