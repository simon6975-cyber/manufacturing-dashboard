...
const processes: ProcessData[] = [
  ...
  { no: 3,  name: 'R2C 1호기',       model: 'S2020',        maker: 'TECHNAU',    status: 'RUN',   queue: 4953, inProgress: 1190, completed: 5047, jobProgress: 78, queueThreshold: DEFAULT_QUEUE_THRESHOLD, dailyProduction: 8200,  dailyTarget: 8000,  stopReason: '',   bottleneckReason: '' },
  { no: 4,  name: 'R2C 2호기',       model: 'S2320',        maker: 'TECHNAU',    status: 'IDLE',  queue: 5761, inProgress: 2071, completed: 4239, jobProgress: 0,  queueThreshold: DEFAULT_QUEUE_THRESHOLD, dailyProduction: 7800,  dailyTarget: 8000,  stopReason: 'S1', bottleneckReason: 'BN1' },
  ...
  { no: 11, name: '수동재단 2호기',   model: 'C860',         maker: '대호',        status: 'IDLE',  queue: 3198, inProgress: 1211, completed: 2802, jobProgress: 0,  queueThreshold: DEFAULT_QUEUE_THRESHOLD, dailyProduction: 4800,  dailyTarget: 5000,  stopReason: '',   bottleneckReason: '' },
  ...
  { no: 17, name: '시험지접지기',     model: 'CSMO',         maker: 'HUNKELER',   status: 'IDLE',  queue: 1278, inProgress: 548,  completed: 522,  jobProgress: 0,  queueThreshold: DEFAULT_QUEUE_THRESHOLD, dailyProduction: 1100,  dailyTarget: 2000,  stopReason: '',   bottleneckReason: '' },
  ...
  { no: 19, name: '댐지포장',         model: '',             maker: '',           status: 'IDLE',  queue: 854,  inProgress: 508,  completed: 646,  jobProgress: 0,  queueThreshold: DEFAULT_QUEUE_THRESHOLD, dailyProduction: 1300,  dailyTarget: 1500,  stopReason: '',   bottleneckReason: '' },
];
